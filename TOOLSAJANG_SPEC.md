...
| 블로그 인라인 | `/blog/*` | `blog-inline-{n}` | AdSense | 본문 3~4문단마다 |
| 블로그 하단 | `/blog/*` | `blog-bottom` | AdSense | 글 끝 |
| 블로그 목록 사이 | `/blog` | `blog-list-{n}` | AdSense | 카드 3~4개마다 |
...
- **파일 위치**: `src/data/blog/` 폴더 내 `.mdx` 파일
...
thumbnail: "/images/blog/margin-vs-markup.png"
author: "툴사장"
published: true
...
| 블로그 글 | {글 제목} ㅣ 툴사장 | {글 description} |
